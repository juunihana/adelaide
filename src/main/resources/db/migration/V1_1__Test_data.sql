...
insert into category(id, title, parent_id, create_time)
...
insert into product(id, title, description, price, create_time, category_id)
...
-- MEN'S CLOTHING TEST
insert
into category(id, title, parent_id, create_time)
